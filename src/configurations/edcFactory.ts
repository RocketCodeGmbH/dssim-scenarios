...
edc.dsp.callback.address=http://${hostname}:${endpoints.find(e => e.name === 'protocol')?.port
    }/api/v1/dsp
...
edc.dataplane.token.validation.endpoint=http://${hostname}:${endpoints.find(e => e.name === 'control')?.port
    }/api/control/token
